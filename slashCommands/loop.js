...
const { handlemsg } = require(`${process.cwd()}/handlers/functions`);
    module.exports = {
  name: `loop`,
  description: `Повторяет песню/очередь по кругу`,
  parameters: {
    "type": "music",
    "activeplayer": true,
    "check_dj": true,
  ...
  options: [ 
    {"StringChoices": { name: "looptype", description: "Что вы хотите повторить?", required: true, choices: [["Song Loop", "song"], ["Queue Loop", "queue"]] }},
  ],
