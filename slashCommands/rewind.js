...
const { handlemsg } = require(`${process.cwd()}/handlers/functions`);
    module.exports = {
  name: `rewind`,
  description: `Переходит на определенное количество секунд назад`,
  parameters: {
    "type": "music",
    "activeplayer": true,
    "check_dj": true,
  ...
  options: [
    {"Integer": { name: "seconds", description: "На какое количество секунд вы хотите перейти назад?", required: true }}, 
  ],
