...
module.exports = {
  ...
  category: `🎶 Music`,
  aliases: [`save`, `yoink`],
  description: `Сохраняет текущую воспроизводимую песню в ваших личных сообщениях`,
  usage: `grab`,
  parameters: {
    "type": "music",
    "activeplayer": true,
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    ...
    message.react(emoji.react.SUCCESS).catch(e => console.log("Не мог отреагировать"))
  }
};
